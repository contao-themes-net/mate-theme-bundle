                ...
                ((n = r),
                  ...
                  this.each(function (t) {
                    ...
                    (o = function () {
                      ...
                      (i = a),
                      (n = o),
                      ((s = T((e = t), "_cashEvents") || L(e, "_cashEvents", {}))[i] = s[i] || []),
                      s[i].push(n),
  ...
  (function (t, e) {
    ...
    function d(t) {
      ...
      return "[object String]" === i
        ? n(t)
        : s(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(i) && t.hasOwnProperty("length")
          ? t
          : s((e = t)) && 0 < e.nodeType
            ? [t]
            : [];
    ...
    function u(t) {
      ...
      return (
        ...
        void 0 !== t.getBoundingClientRect && (o = t.getBoundingClientRect()),
          ...
          { top: o.top + i.pageYOffset - e.clientTop, left: o.left + i.pageXOffset - e.clientLeft }
      );
    }
    function c(t) {
      var e = "";
    ...
    var p = {
          ...
          (a =
            ...
            (a =
              "touches" in t && t.touches.length
                ? ((o = t.touches[0].pageY - s.top), t.touches[0].pageX - s.left)
        ...
        hide: function (t, e) {
          for (
            var i = (e = e || this).getElementsByClassName("waves-rippling"), n = 0, s = i.length;
            n < s;
            n++
          )
            o(t, e, i[n]);
          r && (e.removeEventListener("touchend", p.hide), e.removeEventListener("touchcancel", p.hide)),
    ...
    function i(e) {
      ...
      if (null !== i) {
        ...
        if ((v.registerEvent(e), "touchstart" === e.type && p.delay)) {
          ...
          p.show(e, i),
          r && (i.addEventListener("touchend", p.hide, l), i.addEventListener("touchcancel", p.hide, l)),
      ...
      (e.init = function (t) {
        ...
        (e.attach = function (t, e) {
          ...
          for (var s = 0, o = t.length; s < o; s++)
            ...
            -1 !== ["input", "img"].indexOf(n) && (h[n](i), (i = i.parentElement)),
        ...
        (e.ripple = function (t, e) {
          ...
          if ((((e = e || {}).wait = e.wait || 0), (e.position = e.position || null), i))
            for (
              ...
              if (
                ((n = t[r]),
                  (s = e.position || { x: n.clientWidth / 2, y: n.clientHeight / 2 }),
                  (o = u(n)),
                  (a.x = o.left + s.x),
                  (a.y = o.top + s.y),
                  (l.pageX = a.x),
...
(M.anime = (function () {
  ...
  function n(t) {
    var e,
      ...
      h = c(o, a);
    for (e in t)
      h.hasOwnProperty(e) || "targets" === e || l.push({ name: e, offset: h.offset, tweens: E(t[e], a) });
    return (
      (s = l),
        (t = b(
          d(
  ...
  function T(t) {
    ...
    function e(t) {
      ...
      (k.remaining
        ...
        : (k.pause(),
        k.completed || ((k.completed = !0), p("complete"), "Promise" in window && (y(), (_ = d())))),
        (g = 0));
    }
    t = void 0 === t ? {} : t;
    var f,
              ...
              [
                  ...
                  value: function (t) {
                    ...
                    menuLinks.forEach(link => {
                      link.addEventListener('mouseleave', () => {
                        link.blur(); // Fokus entfernen, wenn Maus den Link verlässt
                      });
                    });
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    this.options.container
                      ...
                      : t
                      ? t.contains(this.dropdownEl) || h(t).append(this.dropdownEl)
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      l.top ||
                      (l.bottom
                        ? ((h = "bottom"), this.options.coverTrigger || (a -= e.height))
                        : ((this.isScrollable = !0),
                          (n -= 20),
                      ...
                      l[u]
                        ...
                        ? ((d = "right"), (s += l.spaceOnLeft), (o -= l.spaceOnLeft))
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    "static" === h(t).css("position") && h(t).css("position", "relative"),
              ...
              [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    this.options.unsafeHTML && d(t).append(this.options.unsafeHTML);
                  },
                },
                {
    ...
    var t = {
      ...
      e = (function () {
        function s(t) {
          ...
          this.options.unsafeHTML && (this.htmlMessage = this.options.unsafeHTML),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (this.container = document.createElement("ul")),
                      ...
                      p(this.container).addClass("autocomplete-content dropdown-content"),
                      this.$inputField.append(this.container),
                      this.el.setAttribute("data-target", this.container.id);
                    var t = p.extend({}, s.defaults.dropdownOptions, this.options.dropdownOptions),
                      i = t.onItemClick;
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    e === M.keys.ENTER && 0 <= this.activeIndex
                      ? (i = p(this.container).children("li").eq(this.activeIndex)).length &&
                      ...
                      0 <= this.activeIndex &&
                      ((this.$active = p(this.container).children("li").eq(this.activeIndex)),
                  ...
                  value: function (t, i) {
                    ...
                    for (var a = 0; a < e.length; a++) {
                      ...
                      if (this.options.allowUnsafeHTML)
                        u.innerHTML = d[0] + '<span class="highlight">' + d[1] + "</span>" + d[2];
                      else if ((u.appendChild(document.createTextNode(d[0])), d[1])) {
                  ...
                  value: function (t, e, i) {
                    ...
                    for (var m = !1, g = 0, y = 0; g < v; g++) {
                      var _ = new Date(t, e, g - a + 1),
                        k = !!$._isDate(this.date) && $._compareDates(_, this.date),
                        b = $._compareDates(_, s),
                        ...
                        M = e,
                        L = t,
                        T = n.startRange && $._compareDates(n.startRange, _),
                        x = n.endRange && $._compareDates(n.endRange, _),
                        O = n.startRange && n.endRange && n.startRange < _ && _ < n.endRange;
                      C && (L = g < a ? ((E = p + E), (M = h), u) : ((E -= o), (M = d), c));
                      var B = {
                        day: E,
                        month: M,
                        year: L,
                      ...
                      7 == ++y &&
                      (r.push(this.renderRow(l, n.isRTL, m)), (y = 0), (m = !(l = [])));
                    }
                ...
                },
                {
                  ...
                  value: function () {
                    (this.$modalEl = h(f._template)),
                      ...
                      (this.modalEl.id = "modal-" + this.id);
                    var t = this.options.container,
                      e = t instanceof HTMLElement ? t : document.querySelector(t);
                ...
                },
                {
                  ...
                  value: function () {
                    (this.wrapper = this.$el.parent()[0]),
                      ...
                      (this.originEl = I(this.wrapper).find(".tap-target-origin")[0]),
      ...
      t = (function (t) {
        function n(t, e) {
          ...
          return i.$el.hasClass("browser-default")
            ...
            : (((i.el.M_FormSelect = i).options = r.extend({}, n.defaults, e)),
            ...
            _createClass(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (!r(e).hasClass("disabled") && !r(e).hasClass("optgroup")) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var t = r('<div class="hide-select"></div>');
                    r(this.wrapper).append(t),
                    ...
                    this.$selectOptions.each(function (t) {
                      if (r(t).is("option")) {
                        var e = n._createAndAppendOptionWithIcon(
                          t,
                          n.isMultiple ? "multiple" : void 0
                        );
                        n._addOptionToValues(t, e);
                      } else if (r(t).is("optgroup")) {
                        var i = r(t).children("option");
                        r(n.dropdownOptions).append(
                          r(
                      ...
                      r(this.wrapper).append(this.dropdownOptions),
                    ...
                    this.el.disabled && r(this.input).prop("disabled", "true"),
                      r(this.wrapper).prepend(this.input),
                      this._setValueToInput();
                    var e = r(
                      '<svg class="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>'
                    );
                    if ((r(this.wrapper).prepend(e[0]), !this.el.disabled)) {
                      var i = r.extend({}, this.options.dropdownOptions);
                      i.coverTrigger = !1;
                      var s = i.onOpenEnd;
                      (i.onOpenEnd = function (t) {
                        var e = r(n.dropdownOptions).find(".selected").first();
                        if (
                          e.length &&
                          ((M.keyDown = !0),
                        ...
                        s && "function" == typeof s && s.call(n.dropdown, n.el);
                      }),
                        (i.closeOnClick = !1),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    if (s) {
                      var a = r('<img alt="" class="' + o + '" src="' + s + '">');
                      i.prepend(a[0]);
                    }
                    return r(this.dropdownOptions).append(i), i;
                  },
                },
                {
                  key: "_selectValue",
                  value: function (t) {
                    (t.el.selected = !0), t.optionEl.classList.add("selected");
                ...
                },
                {
                  key: "_deselectValue",
                  value: function (t) {
                    (t.el.selected = !1), t.optionEl.classList.remove("selected");
                    var e = t.optionEl.querySelector('input[type="checkbox"]');
                    e && (e.checked = !1);
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    var i = this;
                    this._values.forEach(function (t) {
                      var e = r(t.el).prop("selected");
                      r(t.optionEl).find('input[type="checkbox"]').prop("checked", e),
                        e
                          ? i._activateOption(r(i.dropdownOptions), r(t.optionEl))
                          : r(t.optionEl).removeClass("selected");
                    });
                  },
                },
                {
