...
use ContaoThemesNet\MateThemeBundle\Module\MateThemeSetup;

ArrayUtil::arrayInsert($GLOBALS['TL_CTE'], 1, ['mateTheme' => []]);
ArrayUtil::arrayInsert($GLOBALS['FE_MOD'], 1, ['mateTheme' => []]);
ArrayUtil::arrayInsert($GLOBALS['BE_MOD'], 1, ['mateTheme' => []]);
...
ArrayUtil::arrayInsert($GLOBALS['BE_MOD']['contaoThemesNet'], 1, [
    'mateThemeSetup' => [
        'callback' => MateThemeSetup::class,
        'tables' => [],
        'stylesheet' => 'bundles/contaothemesnetmatetheme/sass/backend.css',
    ],
]);
